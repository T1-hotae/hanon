...
export const mockNotices: Notice[] = [
  { id: 'n-transfer-1', category: 'transfer', title: '2026학년도 2학기 전과 신청 안내', url: 'https://example.edu/notices/transfer-2026-fall', postedAt: day('2026-07-15') },
  { id: 'n-transfer-2', category: 'transfer', title: '전과 지원 자격 및 선발 기준 공지', url: 'https://example.edu/notices/transfer-eligibility', postedAt: day('2026-07-08') },
  ...
  { id: 'n-transfer-4', category: 'transfer', title: '전과 합격자 학점 인정 안내', url: 'https://example.edu/notices/transfer-credit', postedAt: day('2026-06-24') },
  ...
  { id: 'n-course-2', category: 'course', title: '2026학년도 2학기 본수강신청 일정 공지', url: 'https://example.edu/notices/course-main', postedAt: day('2026-07-14') },
  ...
  { id: 'n-etc-3', category: 'etc', title: '2026년 8월 졸업예정자 학위수여 요건 확인 안내', url: 'https://example.edu/notices/graduation', postedAt: day('2026-07-05') },
